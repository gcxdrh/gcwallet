...
static const int COINBASE_MATURITY_GC = 10;
...
static const int64 GENESIS_BLOCK_TIME = 1504374544;
...
static const uint256 hashGenesisBlockOfficial("0x00000016c5a3241fb246c5000e2932e2edfbb4995cd5b9297f64c2f76d27f81c");
...
public:
    ...
    {
        // zgc: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // zgc: get transaction coin age
...
public:
    ...
    // zgc: block signature - signed by coin base txout[0]'s owner
    ...
    // zgc: two types of block: proof-of-work or proof-of-stake
    ...
    // zgc: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // zgc: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // zgc: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // zgc: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // zgc: block index flags
    enum  
    {
