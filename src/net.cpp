...
{
    // Wait for IRC to get it first - disabled with zgc
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GC " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are zgc dns seeds.
static const char *strDNSSeed[][2] = {
    {"g1.arssr.com", "g2.arssr.com"},{"g4.arssr.com","g5.arssr.com"},{"g6.arssr.com","g7.arssr.com"},{"g8.arssr.com","g9.arssr.com"},{"g10.arssr.com","g11.arssr.com"}
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // zgc enables dns seeding with testnet too
    {
...
unsigned int pnSeed[] =
{
    0xb9f66c27,0xa1f66c27,0xadc7403a,0xaec7403a,0xb6c7403a,0xb7c7403a
};
...
bool BindListenPort(string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, sizeof(sockaddr)) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to port %d on this computer.  GC is probably already running."), ntohs(sockaddr.sin_port));
        else
...
void StartNode(void* parg)
{
    ...
    // zgc: mint proof-of-stake blocks in the background
