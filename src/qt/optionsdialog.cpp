        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start GC on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start GC after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the GC client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show GC addresses in the transaction list"));
